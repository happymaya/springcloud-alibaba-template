...
public class AddressServiceTest extends BaseTest {
    ...
    public void testCreateAddressInfo() {
        ...
        log.info("test create address info: [{}]", JSON.toJSONString(addressService.createAddressInfo(new AddressInfo(loginUserInfo.getId(), Collections.singletonList(addressItem)))));
    }
    ...
    public void testGetCurrentAddressInfo() {
        ...
        log.info("test get current user info: [{}]", JSON.toJSONString(addressService.getCurrentAddressInfo()));
    }
    ...
    public void testGetAddressInfoById() {
        ...
        log.info("test get address info by id: [{}]", JSON.toJSONString(addressService.getAddressInfoById(1L)));
    }
    ...
    public void testGetAddressInfoByTableId() {
        ...
        log.info("test get address info by table id: [{}]", JSON.toJSONString(addressService.getAddressInfoByTableId(new TableId(Collections.singletonList(new TableId.Id(1L))))));
    }
}
