...
import cn.happymaya.sat.constant.GoodsConstant;
import cn.happymaya.sat.dao.SatGoodsDao;
...
import cn.happymaya.sat.service.IGoodsService;
...
public class GoodsServiceImpl implements IGoodsService {
    ...
    private final SatGoodsDao satGoodsDao;

    public GoodsServiceImpl(StringRedisTemplate redisTemplate,
                            SatGoodsDao satGoodsDao) {
        this.redisTemplate = redisTemplate;
        this.satGoodsDao = satGoodsDao;
    }
    ...
    public List<GoodsInfo> getGoodsInfoByTableId(TableId tableId) {
        ...
        List<SatGoods> ecommerceGoods = IterableUtils.toList(
                satGoodsDao.findAllById(ids)
        );

        return ecommerceGoods.stream()
                .map(SatGoods::toGoodsInfo).collect(Collectors.toList());
    }
    ...
    public PageSimpleGoodsInfo getSimpleGoodsInfoByPage(int page) {
        ...
        Page<SatGoods> orderPage = satGoodsDao.findAll(pageable);
        ...
        return new PageSimpleGoodsInfo(
                orderPage.getContent().stream()
                        .map(SatGoods::toSimple).collect(Collectors.toList()),
                hasMore
        );
    }
    ...
    public Boolean deductGoodsInventory(List<DeductGoodsInventory> deductGoodsInventories) {
        ...
        satGoodsDao.saveAll(ecommerceGoods);
