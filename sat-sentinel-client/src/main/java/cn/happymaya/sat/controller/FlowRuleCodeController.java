...
import cn.happymaya.sat.block_handler.HappymayaBlockHandler;
...
//    @SentinelResource(value = "flowRuleCode", blockHandler = "handleException")
    @SentinelResource(
            value = "flowRuleCode", blockHandler = "happymayaHandleBlockException",
            blockHandlerClass = HappymayaBlockHandler.class
    )
    public CommonResponse<String> flowRuleCode() {
        log.info("request flowRuleCode");
        return new CommonResponse<>(0, "", "happymaya-sat");
    }
